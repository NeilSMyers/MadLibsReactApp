...
class MadlibForm extends Component {
  ...
  renderButton = function() {
    ...
    this.inputData = [
      ...
      {placeholder: 'Advective', prop: 'adjectiveTwo', state: this.state.adjectiveTwo},
      ...
      {placeholder: 'Advective', prop: 'adjectiveThree', state: this.state.adjectiveThree},
      ...
      {placeholder: 'Advective', prop: 'adjectiveFour', state: this.state.adjectiveFour},
      ...
      {placeholder: 'Advective', prop: 'adjectiveFive', state: this.state.adjectiveFive},
    ]
